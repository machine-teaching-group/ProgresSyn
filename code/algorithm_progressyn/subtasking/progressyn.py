...
from code.algorithm_progressyn.subtasking.domain_knowledge import number_of_unique_substructures
...
#     assert max([len(t) for t in good_tasks]) == 1
    subtask_indices = subtask_selection_dp(good_codes, good_tasks, K-1, code_complexity, rollout_param)
    while 0 in subtask_indices:
        subtask_indices.remove(0)
